...
Режим «Россия напрямую» автоматически добавляется только в новые управляемые
профили, созданные из поддерживаемых ссылок и конфигураций. Импортированный
пользовательский sing-box JSON не переписывается: его собственные правила остаются
источником истины.
...
- **Свои правила.** Для домена, IP, CIDR или rule-set можно выбрать действие:
  через VPN, напрямую или блокировать.
