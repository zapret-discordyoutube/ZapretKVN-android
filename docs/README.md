...
Обычный VPN-клиент часто отправляет в туннель весь трафик телефона. При подключении Zapret KVN передаёт Android список выбранных приложений, и система направляет в TUN только их соединения. После этого правила профиля решают, куда отправить каждое соединение: через VPN, напрямую или в блокировку.
